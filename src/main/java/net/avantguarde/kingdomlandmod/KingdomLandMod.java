package net.avantguarde.kingdomlandmod;
...
public class KingdomLandMod
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "kingdomlandmod";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();

    public KingdomLandMod(FMLJavaModLoadingContext context)
    {
